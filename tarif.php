...
//	echo $sqlnews2;
	...
	echo '<font color=gray>По информации в 1С на 27-05-2011 11:00:</font><br>';
	...
	if ($sql3->amount>0) echo '</font><br><font color=gray>Цена в 1С: </font><font size=7em>'.$sql3->cost2/$sql3->amount.' руб</font><br>';
