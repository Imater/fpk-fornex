...
function cutText($string, $setlength) { 
  ...
  $sqlnews="SELECT * FROM h116.`tree` WHERE remind != '0000-00-00 00:00:00' AND remind<(NOW() + INTERVAL 2 HOUR + INTERVAL 3 MINUTE) ORDER BY `tree`.`remind` DESC";
...
$phone='none';
	...
	$tim = str_replace("00:00:00","09:00:00",$sql['date1']);
	//DDMMYYhhmm
...
if($phone!='none')
  ...
  $sqlnews="UPDATE h116.`tree` SET remind = '0000-00-00 00:00:00' WHERE id=".$sql['id'];
  $result = mysql_query($sqlnews); 
